...
from repairs.models.repair import Repair
    ...
    def handle(self, *args, **options):
        ...
        with open(csv_file_path, mode='r', encoding='utf-8') as file:
            ...
            for row in reader:
                ...
                cash_payment_str = row.get('Esp√®ce', '0.00').strip().replace('$', '')
...
˙ *cascade08˙˚*cascade08˚é *cascade08éè*cascade08è¢9 *cascade082bfile:///home/amine/coding/web/tek-mag/backend/apps/repairs/management/commands/load_reparations.py