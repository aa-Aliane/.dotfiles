...
REST_AUTH = {
    ...
    "TOKEN_MODEL": None,
    "USER_DETAILS_SERIALIZER": "accounts.serializers.account_user_details.AccountUserDetailsSerializer",
}
...
LOGGING = {
    ...
    "loggers": {
        ...
        "accounts.serializers.account_user_details": {
            "handlers": ["console"],
            "level": "DEBUG",
            "propagate": False,
        },
...
Ú2™J 
™JšJ 
šJâK 2>file:///home/amine/coding/web/tek-mag/backend/conf/settings.py